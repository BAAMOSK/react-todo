...
//THIRD-- add function into main
import { createTodo, completedTodo, deleteTodo, deleteAllCompletedTodo } from './actions/todos';
import './App.css';
  ...
  render() {
    return (
      <div className="App">
        ...
        <hr />
        <br />
        <button onClick={this._handleDeleteAllCompleted}>Delete All Completed</button>
      </div>
    );
  }
}
...
export default connect(
  ...
  { createTodo, completedTodo, deleteTodo, deleteAllCompletedTodo },
)(App);
